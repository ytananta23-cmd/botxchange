...
export const Login = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#0A0A0F] px-4 relative overflow-hidden">
      <div className="ambient-glow w-96 h-96 bg-purple-600/20 top-0 left-1/4" />
      <div className="ambient-glow w-96 h-96 bg-blue-600/10 bottom-0 right-1/4" style={{ animationDelay: '2s' }} />
      <motion.div
      ...
      >
        <div className="text-center mb-8">
          ...
          <p className="text-white/60">Log in to your BotXchange account</p>
        </div>
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            <div className="space-y-2">
              <div className="flex justify-between items-center">
                ...
                <button
                  type="button"
                  onClick={() => show('info', 'Coming soon', 'Password reset isn\'t available yet — contact support in the meantime.')}
